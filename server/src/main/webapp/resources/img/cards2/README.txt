...
The individual cards were converted to three versions of png files using
the script below. [Emil Breding 2012-08-20]
...
do
    newName=${f%%.svg}
    newName=`echo ${newName/H/h}`
    newName=`echo ${newName/D/d}`
    newName=`echo ${newName/C/c}`
    newName=`echo ${newName/S/s}`
    newName=`echo ${newName/10/T}`

    echo "Processing $f -> ${newName}_large.png"
    convert -antialias -crop 224x312+260+370 $f	${newName}_large.png

    echo "Processing ${newName}_large.png -> ${newName}_medium.png"
    convert -resize 25% ${newName}_large.png ${newName}_medium.png

    echo "Processing ${newName}_large.png -> ${newName}_small.png"
    convert -resize 16% ${newName}_large.png ${newName}_small.png
done